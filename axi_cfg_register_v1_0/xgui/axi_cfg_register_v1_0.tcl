...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set AXI_Slave [ipgui::add_group $IPINST -name "AXI Slave" -parent ${Page_0}]
  set AXI_DATA_WIDTH [ipgui::add_param $IPINST -name "AXI_DATA_WIDTH" -parent ${AXI_Slave}]
  set_property tooltip {Width of the AXI data bus.} ${AXI_DATA_WIDTH}
  set AXI_ADDR_WIDTH [ipgui::add_param $IPINST -name "AXI_ADDR_WIDTH" -parent ${AXI_Slave}]
  set_property tooltip {Width of the AXI address bus.} ${AXI_ADDR_WIDTH}

  #Adding Group
  set Output_Configuration [ipgui::add_group $IPINST -name "Output Configuration" -parent ${Page_0}]
  set CFG_DATA_WIDTH [ipgui::add_param $IPINST -name "CFG_DATA_WIDTH" -parent ${Output_Configuration}]
