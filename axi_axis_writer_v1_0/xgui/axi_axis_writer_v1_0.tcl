...
proc init_gui { IPINST } {
  ...
  set AXI_ADDR_WIDTH [ipgui::add_param $IPINST -name "AXI_ADDR_WIDTH"]
  set_property tooltip {Width of the AXI address bus.} ${AXI_ADDR_WIDTH}
  set AXI_DATA_WIDTH [ipgui::add_param $IPINST -name "AXI_DATA_WIDTH"]
  set_property tooltip {Width of the AXI data bus.} ${AXI_DATA_WIDTH}
  ipgui::add_param $IPINST -name "AXIS_DATA_WIDTH" -widget comboBox
